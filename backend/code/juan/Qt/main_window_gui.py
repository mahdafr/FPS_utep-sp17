...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.captureWindow_captureFile = QtWidgets.QPlainTextEdit(self.dockWidgetContents_53)
        self.captureWindow_captureFile.setGeometry(QtCore.QRect(20, 30, 361, 161))
        self.captureWindow_captureFile.setObjectName("captureWindow_captureFile")
        self.captureWindow_list = QtWidgets.QListWidget(self.dockWidgetContents_53)
        self.captureWindow_list.setGeometry(QtCore.QRect(20, 250, 361, 241))
        self.captureWindow_list.setObjectName("captureWindow_list")
        self.label_2 = QtWidgets.QLabel(self.dockWidgetContents_53)
        self.label_2.setGeometry(QtCore.QRect(40, 230, 211, 16))
        ...
        self.FormatterWindow_formatterList.setGeometry(QtCore.QRect(10, 30, 371, 171))
        self.FormatterWindow_formatterList.setObjectName("FormatterWindow_formatterList")
        item = QtWidgets.QListWidgetItem()
        self.FormatterWindow_formatterList.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.FormatterWindow_formatterList.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.FormatterWindow_formatterList.addItem(item)
        self.FormatterWindow_applyFormatter = QtWidgets.QPushButton(self.dockWidgetContents_60)
        self.FormatterWindow_applyFormatter.setGeometry(QtCore.QRect(230, 200, 151, 32))
        self.FormatterWindow_applyFormatter.setObjectName("FormatterWindow_applyFormatter")
        ...
        self.textEdit.setGeometry(QtCore.QRect(1210, 10, 121, 31))
        ...
        self.textBrowser.setGeometry(QtCore.QRect(50, 10, 781, 31))
        self.textBrowser.setObjectName("textBrowser")
        self.main_window_filter = QtWidgets.QPushButton(self.dockWidgetContents)
        self.main_window_filter.setGeometry(QtCore.QRect(840, 10, 71, 31))
        self.main_window_filter.setObjectName("main_window_filter")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Capture file in a list"))
        self.label_8.setText(_translate("MainWindow", "Formatter List"))
        __sortingEnabled = self.FormatterWindow_formatterList.isSortingEnabled()
        self.FormatterWindow_formatterList.setSortingEnabled(False)
        item = self.FormatterWindow_formatterList.item(0)
        item.setText(_translate("MainWindow", "Formatter1"))
        item = self.FormatterWindow_formatterList.item(1)
        item.setText(_translate("MainWindow", "Formatter2"))
        item = self.FormatterWindow_formatterList.item(2)
        item.setText(_translate("MainWindow", "Formatter3"))
        self.FormatterWindow_formatterList.setSortingEnabled(__sortingEnabled)
        self.FormatterWindow_applyFormatter.setText(_translate("MainWindow", "Apply formatter"))
        ...
        self.main_window_filter.setText(_translate("MainWindow", "Fiter"))
