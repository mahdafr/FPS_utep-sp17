...
class Ui_MainWindow(object):
        def setupUi(self, MainWindow):
                ...
                self.horizontalLayoutWidget_4.setGeometry(QtCore.QRect(10, 240, 371, 80))
                ...
                self.horizontalLayoutWidget_5.setGeometry(QtCore.QRect(10, 420, 371, 80))
                ...
                self.Filter_Bar_Button.setGeometry(QtCore.QRect(830, 30, 141, 31))
                self.Filter_Bar_Button.setObjectName("Filter_Bar_Button")
                self.Filter_Bar_input = QtWidgets.QTextEdit(self.dockWidgetContents)
                self.Filter_Bar_input.setGeometry(QtCore.QRect(50, 10, 781, 51))
                self.Filter_Bar_input.setObjectName("Filter_Bar_input")
                self.search_pdml_button = QtWidgets.QPushButton(self.dockWidgetContents)
                self.search_pdml_button.setGeometry(QtCore.QRect(830, 10, 141, 31))
                self.search_pdml_button.setObjectName("search_pdml_button")
        ...
        def retranslateUi(self, MainWindow):
                ...
                self.Filter_Bar_Button.setText(_translate("MainWindow", "Protocol Filtering"))
                self.search_pdml_button.setText(_translate("MainWindow", "Search PDML"))
